...
@section('title', 'Owner Register Page')
@section('content')
    <!-- Page Content -->
    <div class="content">
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                <div class="login-header">
                                    <h3><span class="text-muted">Futlance | </span>Owner Register <a
                                            href="{{ route('user.create') }}">Not a Owner?</a></h3>
                                </div>

                                <!-- Register Form -->
                                <form action="{{ route('user.owner_store') }}" method="post">
                                    @csrf
